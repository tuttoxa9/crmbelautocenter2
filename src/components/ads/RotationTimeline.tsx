      ...
      <div className="bg-zinc-50 border-b border-zinc-200 px-3 py-2 flex flex-col sm:flex-row gap-2 sm:items-center sm:justify-between">
        ...
        <div className="flex items-center justify-between sm:justify-end gap-3 w-full sm:w-auto">
          ...
          {onBalance && (
            <button 
              onClick={onBalance}
              className="flex items-center gap-1 bg-white hover:bg-zinc-100 border border-zinc-200 text-zinc-700 px-2 py-1 rounded-md text-[10px] font-semibold transition-colors shadow-2xs w-full sm:w-auto justify-center sm:justify-start"
